...
namespace BookUniverse.DAL.Repositories.GoogleDriveRepository
{
    public class GoogleDriveRepository: IGoogleDriveRepository
    {
        ...
        public DriveService GetService()
        {
            ...
            using (var stream = new FileStream(@"C:\Users\User\Downloads\client_secret_929760538234-mire9mlmngsa5mkfjl8hqiamso5t3muv.apps.googleusercontent.com.json", FileMode.Open, FileAccess.Read))
            {
                String FolderPath = @"C:\";
        ...
        //            System.Web.HttpContext.Current.Server.MapPath("~/GoogleDriveFiles"),
        ...
        public void DeleteFile(GoogleDrive files)
        {
            DriveService service = GetService();
            try
            {
